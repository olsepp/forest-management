...
public class WorkOrderService : IWorkOrderService
{
    ...
    private static WorkOrderDto MapToDto(WorkOrder w) => new()
    {
        ...
        AssignedToUserFirstName = w.AssignedTo?.FirstName,
        AssignedToUserLastName = w.AssignedTo?.LastName,
        AssignedById = w.AssignedById,
        AssignedByUserName = w.AssignedBy?.UserName ?? string.Empty,
        AssignedByUserFirstName = w.AssignedBy?.FirstName,
        AssignedByUserLastName = w.AssignedBy?.LastName,
